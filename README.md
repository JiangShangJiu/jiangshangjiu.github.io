...
- 机器人：运动规划（RRT、Ruckig、TOPP-RA）、运动学与动力学（DH、雅可比、拉格朗日、参数辨识）、标定（运动学/TCP/手眼）、状态估计（卡尔曼滤波、EKF、ESKF/IMU）、电机控制（FOC）、力控（阻抗/导纳）、双臂协同（协同任务空间、抓取矩阵与内力）、视觉伺服（IBVS/PBVS）、碰撞检测与协作安全、关节硬件选型、实时系统（PREEMPT_RT、EtherCAT）、软件架构（ROS 2）
